function doGet() {
  ...
  sheet.getRange("J6").setValue(Number(sheet.getRange("J3").getValue()) || 0);
  sheet.getRange("L6").setValue(Number(sheet.getRange("L2").getValue()) || 0);
  ...
  while (sum < 4) {
    if (last == Number(sheet.getRange("O5").getValue())) last = 1; // 防止無限循環
    var t = 1;
